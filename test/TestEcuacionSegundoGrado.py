...
class TestEcuacionSegundoGrado(unittest.TestCase):
    ...
    def test_calculoESG_dosNumeros_retornaSolucion(self):
        ...
        # Assert
        self.assertAlmostEqual(resultadoActualRaiz1, resultadoEsperadoRaiz1, places=2)
        self.assertAlmostEqual(resultadoActualRaiz2, resultadoEsperadoRaiz2, places=2)
    ...
    def test_calculoESG_DiccionarioDosNumeros_retornaSolucion(self):
        ...
        for item in items:
            with self.subTest(item["Case"]):
                resultadoEsperadoRaiz1, resultadoEsperadoRaiz2 = self.calculoRaices.calculoESG(item["a"], item["b"], item["c"])
                resultadoActualRaiz1 = item["RaizEsperada1"]
                resultadoActualRaiz2 = item["RaizEsperada2"]
                self.assertAlmostEqual(resultadoEsperadoRaiz1, resultadoActualRaiz1, places=2)
                self.assertAlmostEqual(resultadoEsperadoRaiz2, resultadoActualRaiz2, places=2)
